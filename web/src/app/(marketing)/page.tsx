    ...
    <main className="marketing-page">
      <header className="marketing-nav">
        ...
        <nav aria-label="营销导航">
          ...
          <Link className="marketing-nav-cta" href="/signup">
            免费注册
          </Link>
        </nav>
      </header>
      ...
      <section className="marketing-hero" aria-labelledby="marketing-title">
        <div className="hero-copy">
          ...
          <div className="hero-actions">
            <Link className="button primary marketing-primary" href="/signup">
              免费注册
            </Link>
      ...
      <section className="marketing-cta" aria-labelledby="marketing-cta-title">
        ...
        <Link className="button marketing-inverse" href="/signup">
          开始研究
        </Link>
      </section>
      ...
      <footer className="marketing-footer">
        ...
        <div className="risk-copy">
          本平台仅提供 AI 分析研究，不构成投注建议；不提供任何购彩服务；未满 18
          周岁禁止购彩；理性购彩。
        </div>
