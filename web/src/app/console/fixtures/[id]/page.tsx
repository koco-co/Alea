  ...
  return (
    <main className="console-main detail-page fixture-detail-page">
      ...
      <section className="fixture-hero">
        <div className="fixture-hero-title">
          <p>2026 FIFA 世界杯 · MATCH {id}</p>
          <h1>西班牙 vs 阿根廷</h1>
        </div>
        ...
        <div className="fixture-meta">
          <div>
            <span>纽约时间</span>
            <strong>2026-07-19 15:00 ET</strong>
          </div>
          <div>
            <span>北京时间</span>
            <strong>2026-07-20 03:00</strong>
          </div>
          <div>
            <span>比赛场地</span>
            <strong>New York New Jersey Stadium</strong>
          </div>
        </div>
      </section>
      <FixtureDetailTabs />
